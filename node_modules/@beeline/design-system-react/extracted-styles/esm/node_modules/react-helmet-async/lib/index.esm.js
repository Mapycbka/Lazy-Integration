...
import fastCompare from '../../react-fast-compare/index.js';
import invariant from '../../invariant/browser.js';
...
var React19Dispatcher = class extends Component {
  ...
  renderTitle() {
    ...
    return React__default.createElement("title" /* TITLE */, toReactProps(titleAttributes), title);
  }
  renderBase() {
    const { base } = this.props;
    if (!base)
      return null;
    return React__default.createElement("base" /* BASE */, toReactProps(base));
  }
  renderMeta() {
    ...
    if (!meta || !Array.isArray(meta))
      return null;
    return meta.map(
      (attrs, i) => React__default.createElement("meta" /* META */, {
        key: i,
        ...toReactProps(attrs)
      })
    );
  ...
  renderLink() {
    ...
    if (!link || !Array.isArray(link))
      return null;
    return link.map(
      (attrs, i) => React__default.createElement("link" /* LINK */, {
        key: i,
        ...toReactProps(attrs)
      })
    );
  ...
  renderScript() {
    ...
    return script.map((attrs, i) => {
      ...
      return React__default.createElement("script" /* SCRIPT */, { key: i, ...props });
    });
  }
  renderStyle() {
    ...
    return style.map((attrs, i) => {
      ...
      return React__default.createElement("style" /* STYLE */, { key: i, ...props });
    });
  }
  renderNoscript() {
    ...
    return noscript.map((attrs, i) => {
      ...
      return React__default.createElement("noscript" /* NOSCRIPT */, { key: i, ...props });
    });
  }
  render() {
