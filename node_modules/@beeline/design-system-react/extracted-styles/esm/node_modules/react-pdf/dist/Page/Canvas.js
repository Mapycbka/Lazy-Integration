...
import { AnnotationMode } from '../../../pdfjs-dist/build/pdf.js';
...
import { cancelRunningTask, getDevicePixelRatio, makePageCallback, isAbortException } from '../shared/utils.js';
...
function Canvas(props) {
    ...
    return (jsx("canvas", { className: `${_className}__canvas`, dir: "ltr", ref: mergeRefs(canvasRef, canvasElement), style: {
            display: 'block',
            userSelect: 'none',
        }, children: renderTextLayer ? jsx(StructTree, {}) : null }));
}
