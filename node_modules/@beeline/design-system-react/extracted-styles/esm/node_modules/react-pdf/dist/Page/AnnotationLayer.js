...
import { AnnotationLayer as AnnotationLayer$1 } from '../../../pdfjs-dist/build/pdf.js';
...
function AnnotationLayer() {
    ...
    const { filterAnnotations, imageResourcesPath, linkService, onGetAnnotationsError: onGetAnnotationsErrorProps, onGetAnnotationsSuccess: onGetAnnotationsSuccessProps, onRenderAnnotationLayerError: onRenderAnnotationLayerErrorProps, onRenderAnnotationLayerSuccess: onRenderAnnotationLayerSuccessProps, page, pdf: pdf$1, renderForms, rotate, scale = 1, } = mergedProps;
    invariant(pdf$1, 'Attempted to load page annotations, but no document was specified. Wrap <Page /> in a <Document /> or pass explicit `pdf` prop.');
    ...
    useEffect(function renderAnnotationLayer() {
        if (!pdf$1 || !page || !linkService || !annotations) {
            return;
        }
        ...
        const annotationLayerParameters = {
            ...
            annotationStorage: pdf$1.annotationStorage,
    ...
    return (jsx("div", { className: clsx('react-pdf__Page__annotations', 'annotationLayer'), ref: layerElement }));
}

export { AnnotationLayer as default };
