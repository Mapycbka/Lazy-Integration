...
import mergeRefs from '../../merge-refs/dist/index.js';
...
import { isProvided, cancelRunningTask, makePageCallback } from './shared/utils.js';
...
function Page(props) {
    ...
    function renderMainLayer() {
        switch (renderMode) {
            case 'custom': {
                ...
                return jsx(CustomRenderer, {}, `${pageKey}_custom`);
            }
            case 'none':
                return null;
            case 'canvas':
            default:
                return jsx(Canvas, { canvasRef: canvasRef }, `${pageKey}_canvas`);
        }
    }
    function renderTextLayer() {
        ...
        return jsx(TextLayer, {}, `${pageKey}_text`);
    }
    function renderAnnotationLayer() {
        if (!renderAnnotationLayerProps) {
            return null;
        }
        return jsx(AnnotationLayer, {}, `${pageKey}_annotations`);
    }
    function renderChildren() {
        ...
        return (jsxs(PageContext.Provider, { value: childContext, children: [renderMainLayer(), renderTextLayer(), renderAnnotationLayer(), resolvedChildren] }));
    }
    ...
    return (jsx("div", { className: clsx(_className, className), "data-page-number": pageNumber, 
