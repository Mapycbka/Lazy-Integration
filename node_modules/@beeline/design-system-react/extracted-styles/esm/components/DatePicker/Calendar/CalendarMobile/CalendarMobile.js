...
const CalendarMobile = props => {
    const { value, minValue, maxValue, onSelectDate, outputDateFormat = "yyyy-MM-dd'T'HH:mm:ss'Z'", multiselect, readonly, dataTestId = 'CalendarMobile', } = props;
    ...
    }, [value, minDate, maxDate, minValue, maxValue]);
    ...
    return (jsx(CalendarMobileContainer, { ...props, viewYear: viewYear, children: jsx(CalendarMobileMonths, { minDate: minDate, maxDate: maxDate, viewDate: viewDate, selectedDate: selectedDate, onSelectDay: handleSelectDay, multiselect: multiselect, readonly: readonly }) }));
};
